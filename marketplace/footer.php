            ...
            <div class="feedback-c mt-lg-n5  bg footer_popup" id="feedback">
              <div>
                ...
                <?php else : ?>
                  ...
                  <form action="/marketplace/mail.php" method="POST" class="modal_form footer_form">
      ...
      <div class="container">
        <ul class="bottom-menu list-unstyled py-2">
          <li class="bottom-menu__item">
            <a href="/marketplace/" class="bottom-menu__link"><img class="bottom-menu__link" alt="Альфа Сертификат" src="/img/logow.svg"></a>
          </li>

          <li class="bottom-menu__item">
            <a href="/marketplace/#sertification-types" class="bottom-menu__link">Сертификация</a>
          </li>
          <li class="bottom-menu__item">
            <a href="/marketplace/#algorithm" class="bottom-menu__link">Алгоритм</a>
          </li>
          <li class="bottom-menu__item">
            <a href="/marketplace/#guarantee" class="bottom-menu__link">Преимущества</a>
          </li>
          <li class="bottom-menu__item">
            <a href="/marketplace/#thanks" class="bottom-menu__link">Благодарности</a>
          </li>
          <li class="bottom-menu__item">
            <a href="/marketplace/#faq" class="bottom-menu__link">Вопросы</a>
          </li>
          <li class="bottom-menu__item">
            <a href="/marketplace/#contacts" class="bottom-menu__link">Контакты</a>
          </li>
        </ul>
      </div>
    </div>
