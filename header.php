  ...
  <div class="container">
    ...
    <div class="cont1">
      ...
      <div class="top_telephone">
        ...
        <div>
          <!-- <div class="hiddenPhone" id="hiddenPhoneHeader"> -->
            
          <!-- 8 800...<a href="#" onclick="event.preventDefault(); showHiddenInfo('#hiddenPhoneHeader', '#phoneHeader')">Показать</a> </div> -->
      ...
      <div class="top_phone top_telephone-link">
        ...
        <div class="socweb">
          <!-- <div class="hiddenEmail" id="hiddenEmailHeader">  -->
            <!-- info@...<a href="#" onclick="event.preventDefault(); showHiddenInfo('#hiddenEmailHeader', '#showEmailHeader')">Показать</a> </div> -->
