  ...
  <section class="footer-bottom">
    ...
    <div class="container">
      ...
      <d  iv class="cont1 bottom_wrapper">
        ...
        <p class="top_desc top_desc--bottom">ООО &laquo;Альфа-Сертификат&raquo;<br>ОГРН 1216100034215 от 08.12.2021г<br>ИНН 6154161721
        ...
        <div class="top_address top_address bot_addres">
          ...
          <!-- <div class="hiddenEmail" id="hiddenEmailFooter">  -->
            <!-- info@...<a href="#" class="show-link" onclick="event.preventDefault(); showHiddenInfo('#hiddenEmailFooter', '#emailFooter')">Показать</a> </div> -->
